...
public class CRAZY_HEAD_DANCE : ModuleRules
{
	...
	public CRAZY_HEAD_DANCE(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = PCHUsageMode.UseExplicitOrSharedPCHs;

        // PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore" });
        PublicDependencyModuleNames.AddRange(new string[] { "MediaAssets", "Core", "CoreUObject", "Engine", "InputCore", "RHI", "RenderCore" });
